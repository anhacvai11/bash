...
sudo docker run -d -e WALLET="$WALLET_ADDRESS" -e POOL="$POOL_URL" --name rvn-miner apolikamixitos/2miners-gn:test # Thay 'your_miner_image_name' bằng tên image của bạn
